...
| [Selection, tooltips and actions](06-selection-tooltips-actions.md) | Click / Ctrl+click / right-click, `SetSelection`, tooltip and action content, invoking actions, external data |
